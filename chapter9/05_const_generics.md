...
### 搭配 const fn 和 associated const

上兩集學的 const fn 和 associated const 都能當 const generic 的值：
...
fn make_buffer<T: HasSize>() -> [u8; T::SIZE] {
    [0; T::SIZE]
}

let buf = make_buffer::<Small>(); // [u8; 4]
```
